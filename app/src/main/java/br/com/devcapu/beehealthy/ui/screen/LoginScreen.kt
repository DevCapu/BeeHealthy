package br.com.devcapu.beehealthy.ui.screen
...
import br.com.devcapu.beehealthy.ui.activity.RegisterActivity
import br.com.devcapu.beehealthy.ui.component.FormWithBeeHealthIdentity
import br.com.devcapu.beehealthy.ui.component.OutlineInput
...
private fun LoginContent(
    ...
    val emailIsShowingError by remember { mutableStateOf(false) }

    OutlineInput(
        value = email,
        onValueChange = onEmailChange,
        placeholder = { Text(text = stringResource(id = R.string.email_label)) },
        isShowingError = emailIsShowingError,
        errorMessage = "",
        modifier = Modifier
